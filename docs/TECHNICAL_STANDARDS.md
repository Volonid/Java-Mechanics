...
Java Mechanics is an add-on, not a mod. The primary goal is to bring The Combat Update's aspects into Bedrock Edition, not to mimic Java Edition. While there are certainly many features that this add-on could benefit from, it will not consider that are not related with The Combat Update.
